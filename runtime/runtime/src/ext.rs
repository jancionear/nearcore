...
impl<'a> External for RuntimeExt<'a> {
    fn storage_set(
        ...
        self.trie_update
            .set(storage_key, Vec::from(value));
        Ok(())
    }
    ...
    fn create_action_receipt(
        ...
        self.receipt_manager
            .create_action_receipt(data_ids, receipt_indices, receiver_id)
    }
    ...
    fn submit_promise_resume_data(
        ...
        {
            self.receipt_manager
                .create_promise_resume_receipt(data_id, data)?;
            return Ok(true);
        }
        ...
        // receipt manager.
        self.receipt_manager
            .checked_resolve_promise_yield(data_id, data)
    }
    ...
    fn append_action_create_account(
        ...
        self.receipt_manager
            .append_action_create_account(receipt_index)
    }
