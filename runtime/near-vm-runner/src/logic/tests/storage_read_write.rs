...
fn test_storage_write_with_register() {
    ...
    logic
        .wrapped_internal_write_register(1, key)
        .unwrap();
    logic
        .wrapped_internal_write_register(2, val)
        .unwrap();

    logic
        .storage_write(u64::MAX, 1 as _, u64::MAX, 2 as _, 0)
...
fn test_storage_remove_with_register() {
    ...
    logic
        .wrapped_internal_write_register(1, b"foo")
        .unwrap();

    logic
        .storage_remove(u64::MAX, 1 as _, 0)
        .expect("storage remove ok");
