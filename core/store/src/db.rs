    ...
    fn fmt(
        ...
        match self {
            ...
            | Self::Delete { col, key } => f
                ...
                .field("key", &StorageKey(key))
                .finish(),
            | Self::DeleteAll { col } => f
                .debug_struct("DeleteAll")
                .field("col", col)
                .finish(),
...
impl DBTransaction {
    ...
    pub fn insert(
        ...
        self.ops
            .push(DBOp::Insert { col, key, value });
    }
    ...
    pub fn update_refcount(
        ...
        self.ops
            .push(DBOp::UpdateRefcount { col, key, value });
    }
    ...
    pub fn delete_range(
        ...
        self.ops
            .push(DBOp::DeleteRange { col, from, to });
    }
...
pub trait Database: Sync + Send {
    ...
    fn get_with_rc_stripped(
        ...
        Ok(self
            ...
            .and_then(DBSlice::strip_refcount))
    }
