...
impl ChainStoreAdapter {
    ...
    pub fn head_header(&self) -> Result<BlockHeader, Error> {
        ...
        option_to_not_found(
            self.store
                .get_ser(DBCol::BlockHeader, last_block_hash.as_ref()),
    ...
    pub fn final_head(&self) -> Result<Tip, Error> {
        option_to_not_found(
            self.store
                .get_ser(DBCol::BlockMisc, FINAL_HEAD_KEY),
            "FINAL HEAD",
        )
    }
    ...
    pub fn largest_target_height(&self) -> Result<BlockHeight, Error> {
        match self
            .store
            .get_ser(DBCol::BlockMisc, LARGEST_TARGET_HEIGHT_KEY)
        {
            | Ok(Some(o)) => Ok(o),
            | Ok(None) => Ok(0),
            | Err(e) => Err(e.into()),
    ...
    pub fn get_block_refcount(
        &self,
        block_hash: &CryptoHash,
    ) -> Result<u64, Error> {
        option_to_not_found(
            self.store
                .get_ser(DBCol::BlockRefCount, block_hash.as_ref()),
    ...
    pub fn get_block_header(
        ...
        option_to_not_found(
            self.store
                .get_ser(DBCol::BlockHeader, h.as_ref()),
    ...
    pub fn get_all_block_hashes_by_height(
        ...
        Ok(self
            .store
            .get_ser(DBCol::BlockPerHeight, &index_to_bytes(height))?
            .unwrap_or_default())
    }
    ...
    pub fn get_next_block_hash(
        &self,
        hash: &CryptoHash,
    ) -> Result<CryptoHash, Error> {
        option_to_not_found(
            self.store
                .get_ser(DBCol::NextBlockHashes, hash.as_ref()),
    ...
    pub fn get_block_extra(
        ...
        option_to_not_found(
            self.store
                .get_ser(DBCol::BlockExtra, block_hash.as_ref()),
    ...
    pub fn is_invalid_chunk(
        ...
        self.store
            .get_ser(DBCol::InvalidChunks, chunk_hash.as_ref())
    ...
    pub fn get_chunk_extra(
        ...
        option_to_not_found(
            self.store
                .get_ser(DBCol::ChunkExtra, &get_block_shard_uid(block_hash, shard_uid)),
    ...
    pub fn get_blocks_to_catchup(
        &self,
        prev_hash: &CryptoHash,
    ) -> Result<Vec<CryptoHash>, Error> {
        Ok(self
            .store
            .get_ser(DBCol::BlocksToCatchup, prev_hash.as_ref())?
            .unwrap_or_default())
    }
    ...
    pub fn get_transaction(
        ...
        self.store
            .get_ser(DBCol::Transactions, tx_hash.as_ref())
            .map_err(|e| e.into())
    }
    ...
    pub fn get_receipt(
        ...
        self.store
            .get_ser(DBCol::Receipts, receipt_id.as_ref())
            .map_err(|e| e.into())
    }
    ...
    pub fn get_epoch_light_client_block(
        ...
        option_to_not_found(
            self.store
                .get_ser(DBCol::EpochLightClientBlocks, hash.as_ref()),
    ...
    pub fn get_current_epoch_sync_hash(
        ...
        Ok(self
            .store
            .get_ser(DBCol::StateSyncHashes, epoch_id.as_ref())?)
    }
